...
import 'package:insighteye_web/componets/homealertbox.dart';

import 'package:insighteye_web/constants/constants.dart';
import 'package:insighteye_web/Models/customer.dart';
import 'package:insighteye_web/widgets/customer_history_widget.dart';
import 'package:insighteye_web/widgets/customer_pgm_registration.dart';
...
class CustomerProfilesrc extends StatefulWidget {
  ...
  String? docname;
  String? orgId;
  CustomerProfilesrc({Key? key, this.docname, this.cust, this.orgId})
      : super(key: key);
...
class StatussrcState extends State<CustomerProfilesrc> {
  ...
  Customer cProfile = Customer();
  String currentScr = "programs";
  bool editmode = false;
  bool loading = false;
  // String currentScr = "reg";
  ...
  customerdetails() async {
    try {
      await fb
          ...
          .then((value) {
        setState(() {
          cProfile = Customer.fromMap(value.data());
        });
      });
    } catch (e) {
      print(e);
...
class CustomerViewWrappaer extends StatelessWidget {
  ...
  final cust;
  final String? orgId;
  const CustomerViewWrappaer({Key? key, this.src, this.cust, this.orgId}) : super(key: key);
