...
// import 'package:insighteye_web/services/techvehicle.dart';
// date
import 'package:intl/intl.dart';
import 'package:motion_toast/motion_toast.dart';
import 'package:insighteye_web/Models/techvehicle.dart';
...
class _AssignvehiclecardState extends State<Assignvehiclecard> {
  ...
  Future<void> assignvehicle(BuildContext context) async {
    ...
    await fb.collection("organizations")
          .doc("${widget.orgId}").collection("Garage").doc(widget.docname).set({
      "status": "Ongoing",
      "techname": widget.techname,
      "techuid": widget.techuid
