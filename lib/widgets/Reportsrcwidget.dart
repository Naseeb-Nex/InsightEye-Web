...
class Reportsrcwidget extends StatefulWidget {
  ...
  String? techname;
  String? orgId;
  Reportsrcwidget({Key? key, this.uid, this.techuid, this.techname, this.orgId})
      : super(key: key);
...
class ReportsrcwidgetState extends State<Reportsrcwidget> {
  ...
  set string(String value) => setState(() => _techuid = value);
                                      ...
                                      for (var i = 0;
                                        ...
                                        Padding(
                                          ...
                                          child: Techreportcard(
                                            ...
                                            callback: (val) =>
                                                setState(() => _techuid = val),
                                            selectedUser: _techuid,
                                          ),
                                        )
                                      ]
                                    ],
...
class TechReportstatus extends StatefulWidget {
  ...
  String? techuid;
  String? techname;
  TechReportstatus({Key? key, this.techuid, this.techname, this.orgId})
      : super(key: key);
...
class Techreportstatuswarpper extends StatelessWidget {
  ...
  String? orgId;
  Techreportstatuswarpper(
      {Key? key, this.techuid, this.selectedRprt, this.techname, this.orgId})
      : super(key: key);
