...
import 'package:insighteye_web/componets/assign_pgm_card.dart';
import 'package:insighteye_web/componets/assignvehiclecard.dart';
...
import 'package:insighteye_web/Models/vehicleusagehistory.dart';
                      ...
                      return Column(
                        children: [
                          ...
                          for (var i = 0; i < pendingpgm.length; i++) ...[
                            Assignpgmcard(
                              // If one of the Supervisor created the program assigned by another person it will be tracking here.
                              uid: user != null
                                  ? user?.uid
                                  : pendingpgm[i]["uid"],
...
class AddvehicleDialog extends StatefulWidget {
  ...
  AddvehicleDialog({Key? key, this.techname, this.uid, this.orgId})
      : super(key: key);
