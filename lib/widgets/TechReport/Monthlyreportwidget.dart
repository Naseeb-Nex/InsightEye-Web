...
class MonthlyReportWidget extends StatefulWidget {
  ...
  MonthlyReportWidget({Key? key, this.techuid, this.techname, this.orgId})
      : super(key: key);
        ...
        child: SingleChildScrollView(
          ...
          child: Padding(
            padding: EdgeInsets.symmetric(
                horizontal: s.height * 0.02, vertical: s.height * 0.03),
            child: Container(
              padding: EdgeInsets.symmetric(
          ...
          .doc("${widget.orgId}")
                        ...
                        .doc(month)
                        .collection("summary")
                        .where("techuid", isEqualTo: "${widget.techuid}")
                        .snapshots(),
                    builder: (BuildContext context,
                      ...
                      if (daily_activity_filter == "all") {
                        ...
                        Monthly_filtered_rp = activityrp
                            .where((i) => i['status'] == daily_activity_filter)
                            .toList();
                      }
                        ...
                        children: [
                          ...
                          for (var i = 0;
                            ...
                            Montlystatus(
                              ...
                              techuid: Monthly_search_rs[i]['techuid'],
